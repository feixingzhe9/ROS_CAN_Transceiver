...
if __name__ == '__main__':
    infrared_light_pub = None
    try:
        rospy.init_node('infrared_light', anonymous=True)
        rospy.Subscriber("rx_infrared_light_node", vci_can, data_received)
        infrared_light_pub = rospy.Publisher('tx_infrared_light_node', vci_can, queue_size=10)
        main()

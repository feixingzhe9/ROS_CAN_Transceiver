...
if __name__ == '__main__':
    pressure_laser_pub = None
    try:
        rospy.init_node('pressure_laser', anonymous=True)
        rospy.Subscriber("rx_pressure_laser_node", vci_can, data_received)
        pressure_laser_pub = rospy.Publisher('tx_pressure_laser_node', vci_can, queue_size=10)
        main()
